        ...
        >
            ...
            <div className="w-[270px] text-left pl-4">
                <h3 className="flex flex-col font-['poppins'] tracking-wide">
                    <span className="text-amber-500 text-[14px] font-semibold leading-tight">{player.lastName}</span>
                    <span className="text-white text-[24px] font-semibold -mt-1">{player.firstName}</span>
                </h3>
            </div>
        </div>
    ))}
